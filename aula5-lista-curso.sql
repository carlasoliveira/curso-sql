...
INSERT INTO cidade (id,nome,estado_id,ativo,data_cadastro) VALUES (DEFAULT, 'PARANAVAÍ',1,'S','2022-09-04'); 
INSERT INTO cidade (id,nome,estado_id,ativo,data_cadastro) VALUES (DEFAULT, 'PARAISO DO NORTE',1,'S','2022-09-04'); 
INSERT INTO cidade (id,nome,estado_id,ativo,data_cadastro) VALUES (DEFAULT, 'SAO CARLOS DO IVAI',1,'S','2022-09-04'); 
...
INSERT INTO cidade (id,nome,estado_id,ativo,data_cadastro) VALUES (DEFAULT, 'UMUARAMA',1,'S','2022-09-04'); 
INSERT INTO cidade (nome,estado_id,ativo,data_cadastro) VALUES ('CIANORTE',1,'S','2022-09-04'); 
INSERT INTO cidade (nome,estado_id) VALUES ('LONDRINA',1);

9. Faça a inserção de 2 registros de cliente.  

INSERT INTO cliente (id, nome, cpf, email) VALUES(1, 'Carla', 12345678900, carla@gmail.com), (2, 'Tavares', 98765432100, tavares@gmail.com);
